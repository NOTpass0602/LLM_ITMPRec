...
from llm_itmprec.bridge_regularizer import attach_bridge_regularization
...
def main():
    ...
    parser.add_argument("--bridge_reg_path", type=str, default=None)
    parser.add_argument("--bridge_reg_weight", type=float, default=0.0)
    parser.add_argument("--bridge_reg_samples", type=int, default=256)
    parser.add_argument("--bridge_reg_margin", type=float, default=0.05)
    parser.add_argument("--bridge_reg_min_score_gap", type=float, default=2.0)
    parser.add_argument("--bridge_reg_pair_mode", type=str, default="rank_all", choices=["rank_all", "extreme", "top_bottom"])
    parser.add_argument("--bridge_reg_pos_transition_min", type=float, default=3.0)
    parser.add_argument("--bridge_reg_pos_risk_max", type=float, default=3.0)
    parser.add_argument("--bridge_reg_neg_transition_max", type=float, default=2.0)
    parser.add_argument("--bridge_reg_neg_risk_min", type=float, default=4.0)
    parser.add_argument("--bridge_reg_top_k", type=int, default=8)
    parser.add_argument("--bridge_reg_bottom_k", type=int, default=12)
    ...
    attach_bridge_regularization(trainer, args)
